 ...
 * Oct 14, 2010
 */
public class Step10CullingSurface implements CullingSurface<Step10Attributes> {

	private final DisplayPanel panel;
	
	public Step10CullingSurface(DisplayPanel panel){
		this.panel = panel;
	}
	 ...
	 */
	@Override
	public boolean isInRange(Node<Step10Attributes> node) {
		if(node != null){
			...
			Rectangle2D test = node.getAttributes().getBounds();
