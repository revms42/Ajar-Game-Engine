 ...
 * Oct 14, 2010
 */
public class Step8CullingSurface implements CullingSurface<Step8Attributes> {

	private final DisplayPanel panel;
	
	public Step8CullingSurface(DisplayPanel panel){
		this.panel = panel;
	}
	 ...
	 */
	@Override
	public boolean isInRange(Node<Step8Attributes> node) {
		if(node != null){
