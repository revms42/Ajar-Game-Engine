 ...
 * Sep 9, 2010
 */
public class Step5Attributes implements Attributes {

	private final Step5ObjectType type;
	...
	public Step5Attributes(Shape shape, Step5ObjectType type, Color c){
		this.type = type;
		this.shape = shape;
		this.color = c;
	...
	public Step5ObjectType getType() {
		return type;
	}
	
	@Override
	public Step5Attributes clone() {
		return new Step5Attributes(shape,type,color);
	}
}
