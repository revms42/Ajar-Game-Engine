 ...
 * Sep 9, 2010
 */
public class Step6Attributes implements Attributes {

	private final Step6ObjectType type;
	...
	public Step6Attributes(Shape shape, Step6ObjectType type, Color c){
		this.type = type;
		this.shape = shape;
		this.color = c;
	...
	public Step6ObjectType getType() {
		return type;
	}
	
	@Override
	public Step6Attributes clone() {
		return new Step6Attributes(shape,type,color);
	}
}
