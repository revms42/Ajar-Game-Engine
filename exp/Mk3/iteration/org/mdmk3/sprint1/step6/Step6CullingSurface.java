 ...
 * Oct 14, 2010
 */
public class Step6CullingSurface implements CullingSurface<Step6Attributes> {

	private final DisplayPanel panel;
	
	public Step6CullingSurface(DisplayPanel panel){
		this.panel = panel;
	}
	 ...
	 */
	@Override
	public boolean isInRange(Node<Step6Attributes> node) {
		...
		Rectangle2D test = node.getAttributes().getCollisionSurface().getBounds2D();
