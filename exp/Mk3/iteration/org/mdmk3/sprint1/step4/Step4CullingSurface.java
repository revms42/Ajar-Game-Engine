 ...
 * Oct 14, 2010
 */
public class Step4CullingSurface implements CullingSurface<Step4Attributes> {

	private final DisplayPanel panel;
	
	public Step4CullingSurface(DisplayPanel panel){
		this.panel = panel;
	}
	 ...
	 */
	@Override
	public boolean isInRange(Node<Step4Attributes> node) {
