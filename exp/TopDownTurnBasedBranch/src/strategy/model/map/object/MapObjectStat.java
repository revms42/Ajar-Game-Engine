...
public enum MapObjectStat implements StrategyStat {
	...
	public static MapObjectStat[] STATS = {MAP_X_POS,MAP_Y_POS,MAP_X_DEST,MAP_Y_DEST,MAP_WIDTH,MAP_HEIGHT,MAP_TILE,MAP_FACING,Z_DEPTH,MAP_X_STEP,MAP_Y_STEP};
