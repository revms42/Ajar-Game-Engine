...
public class ActionClassParserTest {
	...
	public void testGetParsedClass() {
		try{
			...
			assertTrue("Parsed Class is not an Action class!", pc.getClass() == ActionClass.class);
			assertTrue("Parsed Class is not Dummy Action!", pc.objectClass() == DummyAction.class);
