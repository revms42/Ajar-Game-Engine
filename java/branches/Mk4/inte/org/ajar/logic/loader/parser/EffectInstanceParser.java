 ...
 *
 */
public class EffectInstanceParser<A extends Effect<?>> extends AbstractInstanceParser<A> {
	...
	public EffectInstanceParser(EffectClassParser classParser) {
		super((AbstractClassParser<A>) classParser);
	}
	 ...
	 */
	@Override
	protected <E extends A> ParsedObject<E> makeParsedObject(ParsedClass<E> type, String line) {
