 ...
 *
 */
public class VerState implements State<HashAttributes> {
	
	private final HashMap<Action, Effect<HashAttributes>> map;
	private final State<HashAttributes> parentState;
	
	public VerState(){
		this.map = new HashMap<Action,Effect<HashAttributes>>();
		parentState = null;
	}
	
	public VerState(State<HashAttributes> parentState){
		this.map = new HashMap<Action,Effect<HashAttributes>>();
		this.parentState = parentState;
	}
	
	public void setAction(Action e, Effect<HashAttributes> effect){
		map.put(e, effect);
	}
