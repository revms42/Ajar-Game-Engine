 ...
 */
package ver.ajar.age.t5.collision;
...
import ver.ajar.age.t5.logic.VerAction;

/**
 * @author mstockbr
 *
 */
public class VerCollidable extends AbstractCollidable<VerAttributes> {

	/**
	 * @param node
	 */
	public VerCollidable(Node<VerAttributes> node) {
		super(node);
	...
	private Action findBoundryCollision(VerAttributes target){
		...
		if(myRect.intersects(theirRect)){
			...
			case Rectangle.OUT_TOP:
				return VerAction.COLLISION_V;
			case Rectangle.OUT_RIGHT | Rectangle.OUT_TOP:
				return VerAction.COLLISION_D;
			case Rectangle.OUT_RIGHT:
				return VerAction.COLLISION_H;
