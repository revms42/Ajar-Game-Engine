...
import ver.ajar.age.t9.logic.effect.VerCheckArrivedEffect;
import ver.ajar.age.t9.logic.effect.VerDefaultEffect;
import ver.ajar.age.t9.logic.effect.VerEnableInputEffect;
import ver.ajar.age.t9.logic.effect.VerEndTurnEffect;
import ver.ajar.age.t9.logic.effect.VerResetDestEffect;
import ver.ajar.age.t9.logic.effect.VerSetDestEffect;
import ver.ajar.age.t9.logic.effect.VerSetRangeEffect;
import ver.ajar.age.t9.logic.effect.VerStartMoveEffect;
...
public class VerEntity extends DefaultEntity<VerAttributes> {
	...
	public VerEntity(Node<VerAttributes> node) {
		...
		VerEndTurnEffect endTurn = new VerEndTurnEffect(waitState);
		
		endTurn.addToChain(setRange.addToChain(enable));
