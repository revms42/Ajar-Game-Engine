...
import ver.ajar.age.t8.display.VerDisplayVisitor;
import ver.ajar.age.t8.display.VerDisplayable;
import ver.ajar.age.t8.collision.CollisionAttribute;
import ver.ajar.age.t8.collision.VerCollidable;
import ver.ajar.age.t8.loader.VerTileMapLoader;
import ver.ajar.age.t8.logic.VerController;
import ver.ajar.age.t8.logic.VerEntity;
import ver.ajar.age.t8.logic.VerLogicVisitor;

/**
 * The purpose of this verification step is to limit movement to a given range and display that
 * range between moves.
 * @author reverend
 *
 */
public class Test8 extends Test<VerAttributes> {
	...
	protected void addNodes(Node<VerAttributes> root) {
		...
		VerController controller = new VerController(
				node.getDecorator(VerEntity.class),
