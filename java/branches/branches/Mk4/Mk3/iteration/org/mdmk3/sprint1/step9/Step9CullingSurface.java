 ...
 * Oct 14, 2010
 */
public class Step9CullingSurface implements CullingSurface<Step9Attributes> {

	private final DisplayPanel panel;
	
	public Step9CullingSurface(DisplayPanel panel){
		this.panel = panel;
	}
	 ...
	 */
	@Override
	public boolean isInRange(Node<Step9Attributes> node) {
		if(node != null){
