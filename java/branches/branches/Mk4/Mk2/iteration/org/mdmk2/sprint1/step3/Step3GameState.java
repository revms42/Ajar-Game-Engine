 ...
 * 11-Sep-10
 */
public class Step3GameState implements State<Step3Attributes> {

	public State<Step3Attributes> perform(StatedImp<Step3Attributes> sImp, Action e) {
		Step3Attributes subject = sImp.getAttributes();
		if(e != null && e instanceof Step3BounceAction){
			Step3BounceAction a = (Step3BounceAction)e;
