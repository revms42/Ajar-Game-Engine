 ...
 * Oct 14, 2010
 */
public class Step7CullingSurface implements CullingSurface<Step7Attributes> {

	private final DisplayPanel panel;
	
	public Step7CullingSurface(DisplayPanel panel){
		this.panel = panel;
	}
	 ...
	 */
	@Override
	public boolean isInRange(Node<Step7Attributes> node) {
		if(node != null){
