...
public class Step7MapLoader extends ImageMapLoader<Step7Attributes> {
			...
			Node<Step7Attributes> fourth)
	{
		...
		boolean emptySecond = first == null || second instanceof NullTileNode;
		boolean emptyThird = first == null || third instanceof NullTileNode;
		boolean emptyFourth = first == null || fourth instanceof NullTileNode;
