 ...
 * Sep 9, 2010
 */
public class Step4Attributes implements Attributes {

	private final Step4ObjectType type;
	...
	public Step4Attributes(Shape shape, Step4ObjectType type){
		this.type = type;
		this.shape = shape;
		switch(type){
		case BALL:
	...
	public Step4ObjectType getType() {
		return type;
	}
	
	@Override
	public Step4Attributes clone() {
		return new Step4Attributes(shape,type);
	}
}
