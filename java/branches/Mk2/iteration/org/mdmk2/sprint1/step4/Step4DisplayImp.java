 ...
 * Sep 10, 2010
 */
public class Step4DisplayImp implements DisplayableImp<Step4Attributes> {

	private Step4Attributes a;
	
	public Step4DisplayImp(Step4Attributes a){
		this.a = a;
	}
	/* (non-Javadoc)
	...
	public void updateDisplay(Graphics2D g2) {
		Step4DisplayFactory.singleton.display(this, g2, getTransform(), a.getColor());
	}
